        ...
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                ...
                <div class="row g-3 mb-4 align-items-center justify-content-between">
                    <div class="col-auto">
                        <h1 class="app-page-title mb-0">Logbook</h1>
                    </div>
                    <div class="col-auto">
                                    ...
                                    <table class="table app-table-hover mb-0 text-left">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="cell"> Rincian Kegiatan</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="cell">Jakarta Selatan - Setia Budi</td>
                                                <td class="cell"><span>Melakukan penyuluhan terdap masyarakat pentingnya parenting kepada anak sejak sedini mungkin, agar menghasilkan generasi yang baik untuk kemajuan bangsa.</span></td>
                                                <td class="cell"><span class="badge bg-success">Diterima</span></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="cell">Jakarta Selatan - Setia Budi</td>
                                                <td class="cell"><span>Melakukan penyuluhan terdap masyarakat pentingnya parenting kepada anak sejak sedini mungkin, agar menghasilkan generasi yang baik untuk kemajuan bangsa.</span></td>
                                                <td class="cell"><span class="badge bg-danger">Ditolak</span></td>
                                                <td class="cell"><a class="btn-sm app-btn-secondary"
                                                        href="#">Ubah</a></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="cell">Jakarta Selatan - Setia Budi</td>
                                                <td class="cell"><span>Melakukan penyuluhan terdap masyarakat pentingnya parenting kepada anak sejak sedini mungkin, agar menghasilkan generasi yang baik untuk kemajuan bangsa.</span></td>
                                                <td class="cell"><span class="badge bg-warning">Diperiksa</span></td>
                                                <td class="cell"><a class="btn-sm app-btn-secondary"
                                                        href="#">Ubah</a></td>
                                            </tr>
