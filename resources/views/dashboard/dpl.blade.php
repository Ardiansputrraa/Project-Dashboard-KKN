...
<head>
    ...
    <script>
        ...
        function getDataDpl() {
            $.ajax({
                url: "{{ route('get.data.dpl') }}",
                type: 'GET',
                success: function(data) {
                    console.log(data);
                    let background = "";
                    if (data[i]['status'] == "Terdaftar") {
                    ...
                    for (let i = 0; i < data.length; i++) {
                        let tabelTemp = `<tr>
                                                ...
                                                <td class="cell"><span class="badge {{  background }}">${data[i]["status"]}</span></td>
                                                <td class="cell">
                                                    <div class="button-group">
                                                        <button class="btn-sm app-btn-secondary" onclick="">
