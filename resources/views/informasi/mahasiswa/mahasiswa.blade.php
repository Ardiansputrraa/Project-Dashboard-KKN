...
<head>
    ...
    <script>
                ...
                success: function(data) {
                    for (let i = 0; i < data.length; i++) {
                        let tabelTemp = `<tr>
                                                ...
                                                <td class="cell">
                                                    <div class="button-group">
                                                        <a class="btn-sm app-btn-secondary" href="/detail-mahasiswa/${data[i]["namaLengkap"]}">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                                height="16" fill="currentColor"
                                                                class="bi bi-pencil-square" viewBox="0 0 16 16">
                                                                <path
                                                        ...
                                                        <button class="btn-sm app-btn-secondary" onclick="deleteDataMahasiswa('${data[i]["namaLengkap"]}')">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                                height="16" fill="currentColor"
                                                                class="bi bi-trash3-fill" viewBox="0 0 16 16">
                                                                <path
        ...
        function deleteDataMahasiswa(namaLengkap) {
            $.ajax({
                type: "GET",
                url: `/delete-data-mahasiswa/${namaLengkap}`,
                data: {
                    _token: "{{ csrf_token() }}"
                },
